...
Pygments. It provides both a CLI tool and library supporting 275 languages
...
- Test validation compares output against a pinned Chroma 2.27 (CI); a mismatched local chroma causes environmental failures
